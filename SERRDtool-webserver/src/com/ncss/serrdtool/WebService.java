...
public class WebService {
	...
	public Meta getQuery(@QueryParam("metricName") String metricName,@QueryParam("DSName") String DSName,
		...
		return metaAccess.getQuery(metricName, DSName, unitName, unit, entityType, entity, startTime, endTime, rows, step);
	}
