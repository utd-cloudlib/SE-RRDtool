...
public class Meta implements Serializable{
	...
	public Meta(int handle,String path, String DSName, String CF, String quantitativeDefinition,  String metricName, String unitName, String unit, String entityType, String entity, long startTime, long endTime, int rows, int step) {
		this.handle = handle;
		this.path = path;
		this.DSName = DSName;
		this.CF = CF;
