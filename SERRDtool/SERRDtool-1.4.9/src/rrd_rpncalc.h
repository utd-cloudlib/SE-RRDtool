...
short     rpn_calc(
    ...
    rrd_value_t *output,
    int output_idx);
char** redirect(int argc, char** argv, int optind);  // modified by Shuai
// optind is the index of file path
void arg_free(char** arg);  // modified by Shuai
// free redirected argument
#endif
